...
public class IhipActivity extends MiSurvillanceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_ihip, contentFrameLayout);
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new DiseaseSummaryFragment(), "Disease Summary");
        adapter.addFragment(new OtbreakSummaryFragment(), "Outbreak Summary");
        adapter.addFragment(new ReportingSummaryFragment(), "Reporting Summary");

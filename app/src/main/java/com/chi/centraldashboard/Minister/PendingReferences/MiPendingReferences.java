...
public class MiPendingReferences extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mi_pending_references);
...
//        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.mi_pending_references, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent intent = new Intent(MiPendingReferences.this, MinisterMainActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_atr) {
            Intent intent = new Intent(MiPendingReferences.this, ATRActivity.class);
            startActivity(intent);
        }

...
public class NursingData {
    ...
    @Expose
    private List<NursingDataList> nursingDataListList = null;
    ...
    public List<NursingDataList> getNursingDataListList() {
        return nursingDataListList;
    }

    public void setNursingDataListList(List<NursingDataList> nursingDataListList) {
        this.nursingDataListList = nursingDataListList;
    }

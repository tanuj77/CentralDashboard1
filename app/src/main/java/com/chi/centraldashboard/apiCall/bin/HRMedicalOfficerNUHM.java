...
public class HRMedicalOfficerNUHM {
    ...
    @Expose
    private String total_medicalofficer_NUHM;
    ...
    public String getTotal_medicalofficer_NUHM() {
        return total_medicalofficer_NUHM;
    }

    public void setTotal_medicalofficer_NUHM(String total_medicalofficer_NUHM) {
        this.total_medicalofficer_NUHM = total_medicalofficer_NUHM;
    }

...
public class HRStaffNurseNUHM {
    ...
    @Expose
    private String total_staffnurse_NUHM;
    ...
    public String getTotal_staffnurse_NUHM() {
        return total_staffnurse_NUHM;
    }

    public void setTotal_staffnurse_NUHM(String total_staffnurse_NUHM) {
        this.total_staffnurse_NUHM = total_staffnurse_NUHM;
    }

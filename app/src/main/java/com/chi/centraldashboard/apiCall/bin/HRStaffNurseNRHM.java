...
public class HRStaffNurseNRHM {
    ...
    @Expose
    private String total_staffnurse_NRHM;
    ...
    public String getTotal_staffnurse_NRHM() {
        return total_staffnurse_NRHM;
    }

    public void setTotal_staffnurse_NRHM(String total_staffnurse_NRHM) {
        this.total_staffnurse_NRHM = total_staffnurse_NRHM;
    }

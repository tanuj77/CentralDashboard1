...
public class MaternalHealth {
    @SerializedName("MATERNAL_HEALTH")
    @Expose
    private List<MaternalHealthList> maternalHealthListList=null;
    ...
    public List<MaternalHealthList> getMaternalHealthListList() {
        return maternalHealthListList;
    }

    public void setMaternalHealthListList(List<MaternalHealthList> maternalHealthListList) {
        this.maternalHealthListList = maternalHealthListList;
    }

...
public class NFHSData {
    @SerializedName("NFHS")
    @Expose
    private List<NFHSDataList> nfhsDataListList = null;
    ...
    public List<NFHSDataList> getNfhsDataListList() {
        return nfhsDataListList;
    }

    public void setNfhsDataListList(List<NFHSDataList> nfhsDataListList) {
        this.nfhsDataListList = nfhsDataListList;
    }

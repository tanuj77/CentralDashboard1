...
public class LeptospirosisData {

    @SerializedName("PCLP")
    @Expose
    private List<LeptospirosisDataList> leptospirosisDataListList = null;
    ...
    public List<LeptospirosisDataList> getLeptospirosisDataListList() {
        return leptospirosisDataListList;
    }

    public void setLeptospirosisDataListList(List<LeptospirosisDataList> leptospirosisDataListList) {
        this.leptospirosisDataListList = leptospirosisDataListList;
    }

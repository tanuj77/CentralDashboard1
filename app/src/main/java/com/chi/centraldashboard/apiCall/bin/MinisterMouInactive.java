...
public class MinisterMouInactive {
    ...
    @SerializedName("Total_No_of_Inactive_MOUs")
    @Expose
    private String Total_No_of_Inactive_MOUs;
    ...
    public String getTotal_No_of_Inactive_MOUs() {
        return Total_No_of_Inactive_MOUs;
    }

    public void setTotal_No_of_Inactive_MOUs(String total_No_of_Inactive_MOUs) {
        Total_No_of_Inactive_MOUs = total_No_of_Inactive_MOUs;
    }
}

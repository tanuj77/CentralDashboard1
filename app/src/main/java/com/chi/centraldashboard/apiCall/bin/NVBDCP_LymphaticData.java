...
public class NVBDCP_LymphaticData {
    @SerializedName("Lymphatic_Filariasis")
    @Expose
    private List<NVBDCP_LymphaticDataList> lymphaticDataListList=null;
    ...
    public List<NVBDCP_LymphaticDataList> getLymphaticDataListList() {
        return lymphaticDataListList;
    }

    public void setLymphaticDataListList(List<NVBDCP_LymphaticDataList> lymphaticDataListList) {
        this.lymphaticDataListList = lymphaticDataListList;
    }

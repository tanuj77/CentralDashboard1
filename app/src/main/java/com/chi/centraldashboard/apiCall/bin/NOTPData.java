...
public class NOTPData {
    @SerializedName("NOTP")
    @Expose
    private List<NOTPDataList> notpDataListList = null;
    ...
    public List<NOTPDataList> getNotpDataListList() {
        return notpDataListList;
    }

    public void setNotpDataListList(List<NOTPDataList> notpDataListList) {
        this.notpDataListList = notpDataListList;
    }

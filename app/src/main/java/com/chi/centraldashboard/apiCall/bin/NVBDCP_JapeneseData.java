...
public class NVBDCP_JapeneseData {
    @SerializedName("Japanese_Encephalitis")
    @Expose
    private List<NVBDCP_JapeneseDataList> nvbdcp_japeneseDataListList = null;
    ...
    public List<NVBDCP_JapeneseDataList> getNvbdcp_japeneseDataListList() {
        return nvbdcp_japeneseDataListList;
    }

    public void setNvbdcp_japeneseDataListList(List<NVBDCP_JapeneseDataList> nvbdcp_japeneseDataListList) {
        this.nvbdcp_japeneseDataListList = nvbdcp_japeneseDataListList;
    }

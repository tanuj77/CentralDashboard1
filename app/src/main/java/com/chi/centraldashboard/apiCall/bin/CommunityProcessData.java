...
public class CommunityProcessData {
    @SerializedName("COMMUNITY_PROCESSES")
    @Expose
    private List<CommunityProcessDataList> communityProcessDataListList = null;
    ...
    public List<CommunityProcessDataList> getCommunityProcessDataListList() {
        return communityProcessDataListList;
    }

    public void setCommunityProcessDataListList(List<CommunityProcessDataList> communityProcessDataListList) {
        this.communityProcessDataListList = communityProcessDataListList;
    }
